...
import { tradePortalStyles } from '../components/plugins-css'
import isElectron from 'is-electron'
import chartsbtc from './charts/btc-charts'
import chartsltc from './charts/ltc-charts'
import chartsdoge from './charts/doge-charts'
import chartsdgb from './charts/dgb-charts'
import chartsrvn from './charts/rvn-charts'
import chartsarrr from './charts/arrr-charts'
import Base58 from '../../../../crypto/api/deps/Base58'
import '../components/TradeInfoView'
import '../components/TraderInfoView'
...
class TradePortal extends LitElement {
			...
			<div class="historic-trades myhover">
				<div class="box">
					...
					<div class="border-wrapper">
						<div class="loadingContainer" id="loadingHistoricTrades" style="display:${this.isLoadingHistoricTrades ? 'block' : 'none'}">
		...
		return html`
			<div class="open-trades myhover">
				<div class="box">
					...
					<div class="border-wrapper">
						<div class="loadingContainer" id="loadingHistoricTrades" style="display:${this.isLoadingOpenTrades ? 'block' : 'none'}">
							<div class="loading"></div>
							<span style="color: var(--black);">${translate("login.loading")}</span>
						</div>
						<vaadin-grid
						...
						>
							...
							<vaadin-grid-column
								...
								.renderer=${(root, column, data) => {
									render(html`
										<span style="cursor: pointer;" @click="${() => this.requestTraderInfo(data.item.qortalCreator)}">
		...
		return html`
			<div class="my-open-orders">
				<div class="box">
					...
					<div class="border-wrapper">
						<div class="loadingContainer" id="loadingHistoricTrades" style="display:${this.isLoadingMyOpenOrders ? 'block' : 'none'}">
							<div class="loading"></div>
							<span style="color: var(--black);">${translate("login.loading")}</span>
						</div>
	...
	pingCoinBalancesController() {
		...
		const customEvent = new CustomEvent('ping-coin-controller-with-coin', { detail: coin })
